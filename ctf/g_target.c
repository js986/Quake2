...
{
	if (ent->spawnflags & 1)
		strncpy(game.helpmessage1, "Welcome to the Ratchet and Clank Mod", sizeof(game.helpmessage2) - 1); //strncpy (game.helpmessage1, ent->message, sizeof(game.helpmessage2)-1);
	else
